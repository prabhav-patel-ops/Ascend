    ...
    <>
      ...
      <Win title="Daily reminders" right={`${reminders.filter((r) => r.on).length} on`}>
        ...
        <button
          ...
          style={{ marginTop: 8 }}
          onClick={async () => {
            const r = await downloadIcs(dailyRemindersIcs(state.hunter.createdAt || "2026-01-01", reminders), "ascend-daily.ics");
    ...
    <>
      ...
      <Win tone="accent" title="Set it up where it works — five minutes">
        ...
        <p className="faint" style={{ marginBottom: 0 }}>
          When this becomes a native app, Apple's Screen Time frameworks can enforce it from inside ASCEND — the same
