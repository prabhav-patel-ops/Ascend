        ...
        {!day || !day.generated ? (
          ...
          <>
            <div className="xp-row">
              ...
              <div className="xp-frac">{cell.earned} of {cell.available} XP</div>
            </div>
            <div className="bar">
      ...
      <Win title="Send to your phone's calendar">
        ...
        <div className="row">
          <button
            ...
            onClick={async () => {
              const r = await downloadIcs(dailyRemindersIcs(todayKey, state.settings.reminders), "ascend-daily.ics");
          ...
          <button
            ...
            onClick={() => {
              ...
              downloadIcs(gatesIcs(state.gates), "ascend-gates.ics");
        ...
        {plan.blocks.length > 0 && (
          <div className="row" style={{ marginTop: 12 }}>
            <button
              className="solid none"
              onClick={async () => {
                const r = await downloadIcs(scheduleIcs(todayKey, plan.blocks), `ascend-${todayKey}.ics`);
